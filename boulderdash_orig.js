...
var viesti0s2k = "VGlCcVlTQkZJR3R2YjNKa2FXNWhZWFJwYmlCcmIyeHRaVzRnZG1scGJXVnBjMlZ1SUc1MWJXVnliMjRnWlhKdmRIVnpJRzl1SURJMkxnPT0=";
var viesti0s1k = Base64.decode(viesti0s2k);
var viesti0 = Base64.decode(viesti0s1k);

var viesti1s2k = "VGlCcVlTQkZJR3R2YjNKa2FXNWhZWFJwWlc0Z2RtbHBiV1ZwYzJWMElHNTFiV1Z5YjNRZ2IzWmhkQ0J3WVhKcGJHeHBjMmxoTGc9PQ==";
var viesti1s1k = Base64.decode(viesti1s2k);
var viesti1 = Base64.decode(viesti1s1k);

var viesti2s2k = "VGlBMk5TQllNaUJxWVNCRk1ESTFJRmszSUMwZ2RNT2tjM1REcENCdmJpQm9lWGJEcENCcVlYUnJZV0VnT2lrTkNnPT0=";
var viesti2s1k = Base64.decode(viesti2s2k);
var viesti2 = Base64.decode(viesti2s1k);

var viesti3s2k = "VEdscGEyRmhJRzl1SUdwdklHRnVibVYwZEhVZ2FtRWdZV2wyWVc0Z2JHbHBZVzRnYUdWc2NHOXNiR0Vo";
var viesti3s1k = Base64.decode(viesti3s2k);
var viesti3 = Base64.decode(viesti3s1k);

var viesti4s2k = "U0hsMmFXNGdjOE9rSUhabFpNT2tkQ0VnVGlBMk5TQXdNaUE0T0ZnZw==";
var viesti4s1k = Base64.decode(viesti4s2k);
var viesti4 = Base64.decode(viesti4s1k);

var viesti5s2k = "UlNCMmFXbHRaV2x6WlhRZ2EyOXNiV1VnYm5WdFpYSnZZU0J2YmlCNWEzTnBkR1ZzYkdWdUlIbG9kR1ZsYmlCc1lYTnJaWFIwZFc1aElHOXVJREV5TGc9PQ==";
var viesti5s1k = Base64.decode(viesti5s2k);
var viesti5 = Base64.decode(viesti5s1k);

var viesti6s2k = "UVdsdVlTQmxhU0IwYVdWa3c2UWdiV2wwdzZRZ2MyRmhJQzBnVGlCcmIyOXlaR2x1WVdGMGFXNGdhMjlzYldWdUlIWnBhVzFsYVhObGJpQnVkVzFsY205dUlITjFiVzFoSUc5dUlESXlMZz09";
var viesti6s1k = Base64.decode(viesti6s2k);
var viesti6 = Base64.decode(viesti6s1k);

var viesti7s2k = "UlRCWVdDQXlOeUF0SUdWMGMya2dhM1YxYzJWemRHRWg=";
var viesti7s1k = Base64.decode(viesti7s2k);
var viesti7 = Base64.decode(viesti7s1k);

var viesti8s2k = "VTJsdWRXNWhJR1YwYzJsemFXNGdVM2w1Ym1sdFlXRnVJSE4xZFc1dWFXeHNZU0JpY25WMFpXeHNZU0IyWVdGdUxDQmxhU0J6WlNCdmFXdHBZWE4wYVNCdmJHVWdaV1JsY3lCMllXbHJhV0V1TGk0PQ==";
var viesti8s1k = Base64.decode(viesti8s2k);
var viesti8 = Base64.decode(viesti8s1k);

var viesti9s2k = "VEdGemEyVWdlV2gwWldWdUlFVTZiaUJxWVNCT09tNGdhMjlzYjIxbElIWnBhVzFsYzNURHBDQnVkVzFsY205aElHNXBhVzRnYzJGaGRDQXhOelEyTGc9PQ==";
var viesti9s1k = Base64.decode(viesti9s2k);
var viesti9 = Base64.decode(viesti9s1k);
  ...
  Game.prototype = {
    ...
    updateRockford: function(p, dir) {
      ...
      if (this.won) {
        ...
        if (this.index===0||this.index===10) alert(viesti0);
	if (this.index===1||this.index===11) alert(viesti1);
	if (this.index===2||this.index===12) alert(viesti2);
	if (this.index===3||this.index===13) alert(viesti3);
	if (this.index===4||this.index===14) alert(viesti4);	
	if (this.index===5||this.index===15) alert(viesti5);
	if (this.index===6||this.index===16) alert(viesti6);	
	if (this.index===7||this.index===17) alert(viesti7);
	if (this.index===8||this.index===18) alert(viesti8);
	if (this.index===9||this.index===19) alert(viesti9); 


                
        //alert("Testifunktio 2, this.index arvo on  :" + this.index);
        this.winLevel();
      }
    },
